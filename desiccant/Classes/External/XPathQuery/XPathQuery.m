...
//           ||     1. add "${SDKROOT}/usr/include/libxml2" to your project's "Header Search Paths"
//           ||     2. add libxml2.dylib to your project
//          \\//    3. add -lxml2 under your project's "Other Linker Flags"
...
NSArray *PerformHTMLXPathQuery(NSData *document, NSString *query, NSString *prefix, NSString *namespaceURI)
{
    xmlDocPtr doc;
	...
	NSArray *result = PerformXPathQuery(doc, query, prefix, namespaceURI);
    xmlFreeDoc(doc); 
	
	return result;
}

NSArray *PerformXMLXPathQuery(NSData *document, NSString *query, NSString *prefix, NSString *namespaceURI)
{
    xmlDocPtr doc;
