                         ...
                         parserWithParserDelegate:[DTXMLCollectionParserDelegate
                                                   ...
                                                   nestedParserDelegate:[DTXMLObjectParserDelegate
                                                                         ...
                                                                         nestedParserDelegates:[NSArray arrayWithObjects:
                                                                                                ...
                                                                                                [DTXMLAttributeParserDelegate delegateWithKey:@"video_url" element:@"enclosure" attribute:@"url" matchingAttributes:[NSDictionary dictionaryWithObject:[NSArray arrayWithObject:@"video/x-mp4"] forKey:@"type"]],
